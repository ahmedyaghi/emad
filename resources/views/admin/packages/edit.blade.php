            ...
            <div class="col-12">
              <form action="{{route('admin.packages.update', ['package' => $package])}}" method="POST">
                ...
                <div class="row alifn-items-center mb-4">
                  <div class="col"> 
                    <h3 class="font-semi-bold mb-2">تعديل الباقة</h3>
                  </div>
                  <div class="col-auto"> <a class="btn btn-white" href="{{route('admin.packages.index')}}">رجوع </a>
                    <button class="btn btn-primary px-3 ms-2" type="submit">تعديل الباقة </button>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                    <div class="package-card">
                      ...
                      <div class="form-group"> 
                        ...
                        <input class="form-control" type="text" placeholder="ادخل اسم الباقة" name="name" value="{{$package->name}}"/>
                        @if ($errors->has('name'))
                      ...
                      <div class="form-group"> 
                        ...
                        <div class="input-icon icon-left">
                          <input class="form-control" type="text" placeholder="ادخل سعر الباقة" name="price" value="{{$package->price}}"/>
                      ...
                      <div class="form-group"> 
                        ...
                        <textarea class="form-control" rows="7" placeholder="تفاصيل الباقة" name="description">{!! $package->description !!}</textarea>
