                ...
                <div class="col">
                  <div class="profile-nav">
                    <ul class="nav nav-pills mb-3 gap-3" role="tablist">
                      <li class="nav-item"><a class="nav-link active" href="users.html">المستخدمين</a></li>
                      <li class="nav-item"><a class="nav-link" href="permission.html">الصلاحيات</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col-auto"> <a class="btn btn-primary" href="users-add.html"> إضافة المستخدم</a></div>
              </div>
            </div>
          </div>
          <div class="row">
              ...
              <div class="widget_item-card p-4 bg-white">
                  ...
                  <div class="col">
                    <div class="widget_item-user d-flex align-items-center">
                      ...
                      <div class="widget_item-user-info">
                        ...
                        <h6 class="text-gray">  رقم الهوية</h6>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="widget_item-info mt-3 d-flex align-items-center flex-wrap border-0">
                  <div class="col-6 mb-4">
                    <div class="d-flex align-items-start"><img class="info-icon me-2" src="../assets/images/call.svg" alt=""/><span class="info-title text-gray">رقم الجوال<span class="font-bold d-block text-black mt-2">+966 555 5555</span></span></div>
                  </div>
                  <div class="col-6 mb-4">
                    <div class="d-flex align-items-start"><img class="info-icon me-2" src="../assets/images/mail.svg" alt=""/><span class="info-title text-gray"> البريد الإلكتروني<span class="font-bold d-block text-black mt-2"> test@text.com</span></span></div>
                  </div>
                  <div class="col-6">
                    <div class="d-flex align-items-start"><img class="info-icon me-2" src="../assets/images/calendar.svg" alt=""/><span class="info-title text-gray">تاريخ الانضمام <span class="font-bold d-block text-black mt-2">  069762865</span></span></div>
                  </div>
                  <div class="col-6">
                    <div class="d-flex align-items-start"><img class="info-icon me-2" src="../assets/images/city.svg" alt=""/><span class="info-title text-gray"> الدور<span class="font-bold d-block text-black mt-2"> مدير النظام</span></span></div>
                  </div>
                </div>
              </div>
            </div>
