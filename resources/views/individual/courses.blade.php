    ...
    <div class="row gx-lg-3">
            <div class="col-12 mb-4">
              <div class="d-flex justify-content-between">
                <div class="col-lg-7">
                  <h3 class="font-semi-bold mb-2"> عرض 8 دورات</h3>
          ...
          <div class="row"> 
            <div class="col-lg-4 col-sm-6">
              <div class="widget_item-card bg-white">
                <div class="widget_item-image mb-3"><a href="my-courses-single.html"> 
                    <picture> <img src="../assets/images/image.png" alt=""/></picture></a></div>
                <div class="widget_item-content">
                  <h4 class="widget_item-title font-semi-bold mb-2"><a href="my-courses-single.html">تدريب في القطاع غير الربحي</a></h4>
