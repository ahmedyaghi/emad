     ...
     <div class="row mb-4">
            ...
            <div class="col-lg-4"> 
              ...
              <div class="pannel">
                ...
                <li class="d-flex align-items-start"><span class="description-icon me-2"><img src="{{asset('assets/images/riyal-circular.svg')}}" alt=""/></span> {{$application->training->salaray}}</li>
