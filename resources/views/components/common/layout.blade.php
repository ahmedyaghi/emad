      ...
      <aside class="sidebar">
          ...
          <ul class="sidebar-menu">
            @switch($role)
              ...
              @case('association')
                <li class="menu-item"><a class="{{ request()->routeIs($role.'.dashboard') ? 'active' : '' }} menu-link" href="{{route($role.'.dashboard')}}"><span class="menu-icon"><img src="{{asset('assets/images/home.svg')}}" alt=""/></span><span class="menu-text"> الصفحة الرئيسية</span></a></li>
                <li class="menu-item"><a class="{{ request()->routeIs($role.'.training-opportunities.*') ? 'active' : '' }} menu-link" href="{{route($role.'.training-opportunities.index')}}"><span class="menu-icon"><img src="{{asset('assets/images/briefcase2.svg')}}" alt=""/></span><span class="menu-text">الفرص التدريبية</span></a></li>
