<div class="swiper-slide">
    <div class="widget_item-card m-2 shadow-none">
        <div class="widget_item-content">
            <h4 class="widget_item-title font-semi-bold mb-2"><a href="{{route('training-opportunity', $model->slug)}}">{{ $model->title}}</a></h4>
            ...
            <div class="widget_item-info mt-3 pt-3 mb-4">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <span class="info-title text-gray">{{ $model->duration}}</span>
                </div>
            </div>
            <div class="widget_item-action row gx-2">
                <div class="col-lg-7"><a class="btn btn-white px-0 w-100" href="{{route('training-opportunity', $model->slug)}}">عرض تفاصيل </a></div>
                <div class="col-lg-5"><a class="btn btn-primary px-0 w-100" href="{{route('training-opportunity', $model->slug)}}">قدّم الآن </a></div>
            </div>
        </div>
    </div>
</div>
