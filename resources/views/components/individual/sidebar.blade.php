<aside class="sidebar">
    ...
    <li class="menu-item"><a class="{{ request()->routeIs('individual.training-opportunity-applications') ? 'active' : '' }} menu-link" href="{{route('individual.training-opportunity-applications')}}"><span class="menu-icon"><img src="{{asset('assets/images/catalogue.svg')}}" alt=""/></span><span class="menu-text">طلباتي</span></a></li>
