<x-common.layout>
    ...
    <div class="row"> 
      <div class="col-12"> 
        <form action="{{route('faculty-member.assessments.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
          <div class="row"> 
            <div class="col-12 mb-4">
              <div class="d-lg-flex justify-content-between">
                ...
                <div class="col-auto"> <a class="btn btn-white" href="{{route('faculty-member.assessments.index')}}">رجوع </a>
