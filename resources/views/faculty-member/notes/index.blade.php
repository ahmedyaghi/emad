     ...
     <div class="row"> 
            <div class="col-12 mb-3">
              <div class="d-flex justify-content-between">
                ...
                <div class="col-lg-auto"><a class="btn btn-primary px-4" href="{{route('faculty-member.notes.create')}}">إضافة ملاحظات</a></div>
              </div>
            </div>
          </div>
              <x-common.search  :placeholder="'البحث عن الملاحظات ...'" :route="route('faculty-member.notes.index')"/>
