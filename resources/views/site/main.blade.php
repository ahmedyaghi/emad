            ...
            <div class="text-center">
              ...
              <div class="row"  data-aos="fade-up" data-aos-delay="200">
                <div class="col-lg-8 mx-auto">
                  <h5 class="mb-4 text-gray">نعمل على تنسيق التكامل والربط بين الطرفين، لتسهيل التوظيف والتدريب والتطوع، وتطبيق المشاريع العملية للمنظمات غير الربحية بشكل منظم. كل ذلك عبر منصة واحدة توفر مقالات إثرائية، وفرصًا وظيفية، ونظام دفع ميسّر للاشتراكات</h5>
                </div>
              </div>
          ...
          <div class="container">
            <div class="section-content">
              ...
              <div class="row mb-4 pb-lg-3">
                <div class="col-lg-8 mx-auto">
                  <div class="text-center">
                    <h4 class="section-desc">انضم إلى فرق عمل المنظمات غير الربحية في المملكة وكن جزءًا من التأثير الإيجابي. نساعدك على الانضمام لمجتمع يساهم في بناء مستقبل أفضل</h4>
                  </div>
                </div>
              </div>
              <div class="row">
