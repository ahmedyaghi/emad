<x-site.layout>
        ...
        <section class="section">
          <div class="container">
            <div class="row mb-4">
              <div class="col-12">
                <h4 class="font-semi-bold mb-3" data-aos="fade-up" data-aos-delay="100">عرض {{count($articles)}} نتيجة مقال</h4>
                ...
                <div class="widget_item-card">
                  ...
                  <div class="widget_item-content">
                    ...
                    <div class="widget_item-campany mb-4 d-flex align-items-center">
                      <div class="campany-image me-2"><img src="{{$article->user->profile?->image}}" alt=""/></div>
                      <h6 class="campany-name">{{$article->user->name}} </h6>
                    </div>
                    <div class="widget_item-info mt-3 pt-3">
                      <div class="d-flex align-items-start"><img class="info-icon me-2" src="{{asset('assets/images/calendar.svg')}}" alt=""/><span class="info-title text-gray">تاريخ النشر<span class="font-bold d-block text-black mt-2">{{$article->created_at}}</span></span></div>
                    </div>
                  </div>
                </div>
              </div>
