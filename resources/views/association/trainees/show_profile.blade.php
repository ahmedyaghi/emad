           ...
           <div class="row mb-lg-2">
            <div class="col-12">
              <div class="row"> 
                <div class="col-12"> 
                  <ol class="breadcrumb">
                    <div class="breadcrumb-item"><a href="">  الطلاب</a></div>
                    <div class="breadcrumb-item">   عبدالله محمد الحربي</div>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <div class="pannel">
                ...
                <div class="widget_item-card">
                  <div class="d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="text-center">
                      <div class="mb-3 circle-progress" id="graph" data-percent="70">
                        <div class="total-result text-white font-semi-bold">70%</div>
                      </div>
                      <h6 class="text-gray">أداء الطالب في الجمعية</h6>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12">
                <div class="pannel">
                  <div class="d-flex align-items-center justify-content-between"> 
                    <h5 class="mb-3 font-bold">التقييمات </h5><a class="btn btn-primary px-4" href="">اعتماد تقييم </a>
                  </div>
                  <hr/>
                  <div class="row"> 
                    <div class="col-lg-4">
            ...
            <div class="row"> 
              <div class="col-12">
                <div class="pannel">
                  <div class="d-flex align-items-center justify-content-between"> 
                    <h5 class="mb-3 font-bold">الملاحظات </h5><a class="btn btn-primary px-4" href="">اعتماد ملاحظة </a>
                  </div>
                  <hr/>
                  <div class="row"> 
                    <div class="col-lg-4">
            ...
            <div class="col-12">
              <div class="profile-nav">
                <ul class="nav nav-pills mb-3 gap-3" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <button class="nav-link " data-bs-toggle="pill" data-bs-target="#tab-4" type="button" role="tab">المرفقات</button>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  <div class="tab-pane fade" id="tab-2">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                      <h5 class="font-bold">المؤهلات</h5>
                    </div>
                    <hr/>
                    <div class="qualification-card mb-3 p-3">
                      <div class="d-lg-flex align-items-center">
                        <div class="qualification-details w-100 row row-cols-lg-5 gx-2 mb-2 mb-lg-0">
                  ...
                  <div class="tab-pane fade" id="tab-3">
                    ...
                    <div class="qualification-card mb-3 p-3">
                      <div class="d-lg-flex align-items-center">
                        <div class="qualification-details w-100 row row-cols-lg-4 gx-2 mb-2 mb-lg-0">
                          <div class="col-lg col-4 mb-4 mb-lg-0">
