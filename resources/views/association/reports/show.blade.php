      ...
      <div class="row mb-lg-2">
            <div class="col-12">
              <div class="row"> 
                <div class="col-12"> 
                  <ol class="breadcrumb">
                    <div class="breadcrumb-item"><a href="">    التقييم الميدان</a></div>
          ...
          <div class="row">
            <div class="col-12"> 
              <div class="pannel">
                ...
                <hr/>
                <h4 class="text-gray">الطلاب ملتزمين ومجتهدين، يُظهر رغبة حقيقية في التحسن. يُنصح بالتركيز أكثر على تصحيح مخارج الحروف في الحفظ الجديد، ومراجعة السور السابقة خلال عطلة نهاية الأسبوع.</h4>
              </div>
            </div>
          </div>
          <div class="row">
                ...
                <div class="qualification-card mb-3 p-3">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="action-buttons ms-4 d-flex gap-3 col-auto">
                      <button class="btn btn-white border-0 btn-icon"><img src="../assets/images/download2.svg" alt=""/></button>
                    </div>
                  </div>
                </div>
                <div class="qualification-card mb-3 p-3">
