                ...
                <div class="pannel">
                  <div class="pannel-head">
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="col-auto"><a class="btn btn-light" href="{{route('consultant.trainees.index')}}"> مشاهدة الكل </a></div>
                    </div>
                  </div>
                ...
                <div class="pannel">
                  <div class="pannel-head">
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="col-auto"><a class="btn btn-light" href="{{route('consultant.reports.index')}}"> مشاهدة الكل </a></div>
                    </div>
                  </div>
                  <div class="pannel-body">
                    <div class="row"> 
