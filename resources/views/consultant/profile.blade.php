                ...
                <div class="pannel p-0">
                  <div class="profile-header">
                    ...
                    <div class="profile-content">
                      <div class="profile-logo"><img src="{{$user->profile->image}}" alt=""/></div>
                          ...
                          <div class="col-lg-3 col-md-4 col-6 mb-4">
                            <div class="d-flex align-items-start">
                              ...
                              <div class="col">
                                ...
                                <h6 class="font-12 font-semi-bold">{{$user->profile->bio}}</h6>
                              </div>
                            </div>
                          </div>
                          {{-- <div class="col-lg-3 col-md-4 col-6 mb-4">
                          ...
                          <div class="col-lg-3 col-md-4 col-6 mb-4">
                            <div class="d-flex align-items-start">
                              ...
                              <div class="col">
                                ...
                                <h6 class="font-12 font-semi-bold">{{$user->profile->website}}</h6>
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-3 col-md-4 col-6 mb-4">
                            <div class="d-flex align-items-start">
                              ...
                              <div class="col">
                                ...
                                <h6 class="font-12 font-semi-bold">{{$user->profile->twitter}}</h6>
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-3 col-md-4 col-6 mb-4">
                            <div class="d-flex align-items-start">
                              ...
                              <div class="col">
                                ...
                                <h6 class="font-12 font-semi-bold">{{$user->profile->facebook}}</h6>
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-3 col-md-4 col-6 mb-4">
                            <div class="d-flex align-items-start">
                              ...
                              <div class="col">
                                ...
                                <h6 class="font-12 font-semi-bold">{{$user->profile->youtube}}</h6>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-lg-3 col-md-4 col-6 mb-4">
                            <div class="d-flex align-items-start">
                              ...
                              <div class="col">
                                ...
                                <h6 class="font-12 font-semi-bold">{{$user->name}}</h6>
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-3 col-md-4 col-6 mb-4">
                            <div class="d-flex align-items-start">
                              ...
                              <div class="col">
                                ...
                                <h6 class="font-12 font-semi-bold">{{$user->profile->position?->name}}</h6>
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-3 col-md-4 col-6 mb-4">
