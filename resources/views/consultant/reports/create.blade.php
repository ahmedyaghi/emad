<x-common.layout>
    <div class="row mb-lg-2">
      <div class="col-12">
        <div class="row"> 
          <div class="col-12"> 
            <ol class="breadcrumb">
              <div class="breadcrumb-item"><a href="{{route('consultant.reports.index')}}">التقارير</a></div>
    ...
    <div class="row">
      <div class="col-12">
          <form action="{{route('consultant.reports.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
          <div class="row">
            <div class="col-12 mb-3">
              <div class="d-flex justify-content-between">
                ...
                <div class="col-lg-auto"><a class="me-2 btn btn-white" href="{{route('consultant.reports.index')}}"> رجوع</a>
