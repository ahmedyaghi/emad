...
class AssessmentController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('consultant.assessments.create', get_defined_vars());
    }
    ...
    public function store(AssessmentRequest $request)
    {
        ...
        return redirect()->route('consultant.assessments.index')->with('success', 'تم حفظ التقييم بنجاح');
    }
    ...
    public function show($id)
    {
        ...
        return view('consultant.assessments.show', get_defined_vars());
    }
}
